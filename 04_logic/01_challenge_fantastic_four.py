...
En el universo de los 4 Fantásticos, la unión y el equilibrio 
entre los poderes es fundamental para enfrentar cualquier desafío. 
...
def check_is_balanced(texto):
    texto = texto.upper()

    # contar cuántas veces aparece una letra
    count_r = texto.count("R") # Reed
    count_j = texto.count("J") # Johnny

    print(f"R: {count_r} \J: {count_j}")

    # if count_r == count_j: return True
    # else: return False

    return count_r == count_j

print(check_is_balanced("JJJJJjjjjjjRRRRRRrrrrr"))
print(check_is_balanced("RRRRRRRj"))
print(check_is_balanced("qqqqq"))
